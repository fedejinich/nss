...
class Stage4BPeerRoomContractTests(unittest.TestCase):
    def test_message_map_contains_stage4b_pack(self) -> None:
        ...
        self.assertEqual(set(index.keys()) & S4B_MESSAGES, S4B_MESSAGES)

        batch = [index[key] for key in sorted(S4B_MESSAGES)]
    ...
    def test_message_schema_contains_stage4b_pack(self) -> None:
