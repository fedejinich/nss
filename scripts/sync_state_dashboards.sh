...
python3 "${ROOT_DIR}/tools/state/generate_runtime_coverage.py"
python3 "${ROOT_DIR}/tools/state/generate_capability_matrix.py"
...
python3 "${ROOT_DIR}/tools/state/verify_release_hardening.py"
