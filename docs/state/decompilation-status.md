...
- Convert S4F/S4G mapped-not-implemented control messages into typed protocol/core/CLI coverage.
- Continue global/system control mappings (`SM_ADD_CHATROOM`, `SM_SET_STATUS`, `SM_HEARTBEAT`, `SM_RELOGGED`, `SM_USER_LIST`, `SM_ROOM_ADDED`, `SM_ROOM_REMOVED`, `SM_CONNECT_TO_CLIENT`).
